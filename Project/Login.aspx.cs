...
public partial class _Default : System.Web.UI.Page
{
   ...
   // SqlConnection con = new SqlConnection(@"Data Source=ADMIN-PC\SQLEXPRESS;Initial Catalog=Sentiment;Integrated Security=True");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlDataAdapter da3 = new SqlDataAdapter("Select fname,mname,lname,contact,uid,email from [MobileStoreDB].[dbo].[Login] where Username='" + txtusername.Text + "' and password='" + txtpassword.Text + "'", con);
            ...
            SqlDataAdapter da2 = new SqlDataAdapter("Select uid,password from [MobileStoreDB].[dbo].[Login] where Username='" + txtusername.Text + "' and password='" + txtpassword.Text + "'", con);
